...
export default function TelaEditarPerfil({ navigation, route }) {
    ...
    const handleUpdate = async () => {
        const [dia, mes, ano] = dataNascimento.match(/.{1,2}/g) || [];
            ...
            <ScrollView contentContainerStyle={styles.container}>
                <TouchableOpacity style={styles.avatarContainer} onPress={pickImage}>
                    ...
                    <View style={styles.cameraIcon}>
                        <FontAwesome5 name="camera" size={getResponsiveFontSize(18)} color="#2c2c2c" />
                    </View>
                </TouchableOpacity>

                <View style={styles.inputGroup}>
                    <Text style={styles.label}>Nome Completo</Text>
                    <TextInput style={styles.input} value={nome} onChangeText={setNome} placeholderTextColor="#a3a3a3" />
                </View>
