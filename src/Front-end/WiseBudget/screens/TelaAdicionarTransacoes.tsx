import { View, StyleSheet, Text, TextInput, TouchableOpacity, Alert, Switch, ScrollView } from "react-native"
            ...
            <View style={{ paddingHorizontal: 20 }}>
                <View style={{ alignItems: 'center' }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <Text style={{ color: '#fdfdfd', fontSize: 45, opacity: 0.5, fontFamily: 'Poppins-Bold', marginRight: 5 }}>R$</Text>
                        <TextInput
                            placeholder="0,00"
